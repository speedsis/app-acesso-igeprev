  ...
  useEffect(() => {
    socket.on(
      ...
      (content: { message: string; name: string; status: boolean }) => {
        ...
        if (content.status) {
          setSolicitation(content.status)
  ...
  async function onSubmit(data: FormValues) {
    ...
    try {
      ...
      socket.emit('solicitation', {
        id: socket.id,
        message: 'Solicita inserir dados de contato.',
        sender: 'IGEPREV',
        recipient: 'speedsis@gmail.com',
        status: false,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 p-4 gap-4 text-black dark:text-white">
          <div className="md:col-span-2 xl:col-span-3">
            <h3 className="text-lg font-semibold">
              Resumos de tarefas de sprints recentes
            </h3>
          </div>
          <div className="md:col-span-2 xl:col-span-1">
            <div className="rounded bg-gray-200 dark:bg-gray-800 p-3">
              <div className="flex justify-between py-1 text-black dark:text-white">
                <h3 className="text-sm font-semibold">Tarefas a fazer</h3>
                <svg
              ...
              <div className="text-sm text-black dark:text-gray-50 mt-2">
                <div className="bg-white dark:bg-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 p-2 rounded mt-1 border-b border-gray-100 dark:border-gray-900 cursor-pointer">
                  Excluir todas as referências
                </div>
                <div className="bg-white dark:bg-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 p-2 rounded mt-1 border-b border-gray-100 dark:border-gray-900 cursor-pointer">
                  Remover codigo de analises
                </div>
                <div className="bg-white dark:bg-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 p-2 rounded mt-1 border-b border-gray-100 dark:border-gray-900 cursor-pointer">
                  Faça um layout
                ...
                <div className="bg-white dark:bg-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 p-2 rounded mt-1 border-b border-gray-100 dark:border-gray-900 cursor-pointer">
                  Verifique as metatags
                </div>
                <div className="bg-white dark:bg-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 p-2 rounded mt-1 border-b border-gray-100 dark:border-gray-900 cursor-pointer">
                  Pense em mais tarefas para este exemplo
                  <div className="text-gray-500 dark:text-gray-200 mt-2 ml-2 flex justify-between items-start">
                    <span className="text-xs flex items-center">
                      <svg
                        className="h-4 fill-current mr-1"
          ...
          <div>
            <div className="rounded bg-gray-200 dark:bg-gray-800 p-3">
              ...
              <div className="text-sm text-black dark:text-gray-50 mt-2">
                ...
                <div className="bg-white dark:bg-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 p-2 rounded mt-1 border-b border-gray-100 dark:border-gray-900 cursor-pointer">
                  Remover analise de codigo
                </div>
                <div className="bg-white dark:bg-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 p-2 rounded mt-1 border-b border-gray-100 dark:border-gray-900 cursor-pointer">
                  Faça um layout mobile primeiro
          ...
          <div>
            <div className="rounded bg-gray-200 dark:bg-gray-800 p-3">
              <div className="flex justify-between py-1 text-black dark:text-white">
                <h3 className="text-sm font-semibold">Tarefas na QA</h3>
                <svg
                  className="h-4 fill-current text-gray-600 dark:text-gray-500 cursor-pointer"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="p-6 mr-2 bg-gray-100 dark:bg-gray-800 sm:rounded-lg">
              ...
              <p className="text-normal text-lg sm:text-2xl font-medium text-gray-600 dark:text-gray-400 mt-2">
                Preencha o formulário para enviar qualquer consulta
              </p>
              ...
              <div className="flex items-center mt-8 text-gray-600 dark:text-gray-400">
                ...
                <div className="ml-4 text-md tracking-wide font-semibold w-40">
                  Cidade, Rua, Estado, Código Postal
                </div>
              </div>
        ...
        <div className="mt-8 mx-4">
          <div className="p-4 bg-blue-50 dark:bg-gray-800 dark:text-gray-50 border border-blue-500 dark:border-gray-500 rounded-lg shadow-md">
            <h4 className="text-lg font-semibold">
              Peguei ideias e reutilizei componentes dos seguintes recursos:
            </h4>
            <ul>
              <li className="mt-3">
                <a
              ...
              <li className="mt-2">
                ...
                >
                  ...
                  <span className="inline-flex pl-2">Formulário Form</span>
                </a>
              </li>
              <li className="mt-2">
                <a
